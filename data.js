...
const HOUSE = [
  {
    ...
    img: "house/coffee-card.jpg",
    p: "We've paid for ten drinks at Four Corners for you. The card's on the fridge under the fish magnet: take it with you and they'll stamp one of the initialled circles each time. Whatever's left when you go, we'll use when we're back, so there's no need to get through them.",
  },
  {
    h: "The TV",
  ...
  {
    h: "Dishwasher",
    img: "house/dishwasher.jpg",
    p: "The buttons are along the top edge of the door, so open it a little to see them.",
    steps: [
      "Tablet in the compartment in the door.",
      "Press the power button on the far left.",
      "Press 70: it's the next button along, with the saucepan on it.",
      "Press start on the far right, then close the door.",
    ],
  },
  {
    h: "Microwave",
    img: "house/microwave.jpg",
    p: "Nothing unusual about it. The quickest way: door shut, then press the long Start button. Each press adds 30 seconds and it starts straight away. Stop/Clear stops it.",
  },
  {
    h: "Air fryer",
    img: "house/air-fryer.jpg",
    p: "It's a Ninja with two drawers, 1 on the left and 2 on the right, and each works on its own.",
    steps: [
      "Food in a drawer, in one layer if you can: spread out it crisps, heaped up it steams.",
      "Press the power button, then 1 or 2 for the drawer you've used.",
      "Press AIR FRY, then set the heat with the TEMP arrows and the time with the TIME arrows.",
      "Press START/STOP.",
      "Halfway through, pull the drawer out, give it a shake, and slide it back.",
    ],
    tip: "It beeps when it's done. The drawers get very hot, so hold the handles only. Rough times, but check the packet: frozen chips at 200 for 15 to 20 minutes, a chicken breast at 180 for about 20, leftovers at 180 for 4 or 5.",
  },
  {
    h: "Washing machine",
    img: "house/washer.jpg",
    p: "The Ecover liquid and the softener are in the basket on top.",
    steps: [
      "Turn the round dial to the third setting from the top, going clockwise.",
      "Press the black play/pause button on the panel to start it.",
    ],
  },
  {
    h: "Tumble dryer",
    img: "house/dryer.jpg",
    p: "It's the one on top of the washing machine.",
    steps: [
...
const WALKS = [
  ...
  {
    id: "harrogate",
    mins: 150, drive: 45, vibe: ["shops","easy","history"],
    name: "Harrogate",
    type: "drive",
    time: "About 45 min drive",
    from: "Harrogate, HG1 2SZ",
    fromHome: "Three quarters of an hour in the car. Park near the centre and the Valley Gardens are a few minutes' walk.",
    summary: "Tea rooms, proper shops, and the Valley Gardens to walk him round afterwards.",
    detail: "A spa town that has kept its manners. Betty's is the famous one and there'll be a queue, but there are plenty of others. The Valley Gardens are the reason to bring Woody: seventeen acres of paths, lawns and flowerbeds, gentle underfoot and open all year. The Stray, the big common by the centre, is another easy lap if the gardens are busy.",
    woody: "Short lead in the town and the gardens. Plenty of other dogs about.",
    route: [[53.99135,-1.55135]],
    end: "Harrogate",
  },
  {
    id: "york",
    mins: 210, drive: 75,
    vibe: ["shops","history","easy"],
    name: "York",
    type: "drive",
    time: "About 1 hr 15 drive",
    from: "York, YO1 7HH",
    fromHome: "An hour and a quarter in the car, so a whole day rather than an afternoon. Use one of the park and rides: driving into the middle is more trouble than it's worth.",
    summary: "The Shambles, the city walls and the Museum Gardens. A proper day out, flat the whole way round.",
    detail: "Park and ride in, then it's all on the level. The Shambles and the little streets around it, the Museum Gardens for a sit down, and the walls if you fancy a walk with a view over the rooftops. Cobbles in places, so mind your footing. Plenty of places will have him inside with you.",
    woody: "Short lead the whole day, it's busy. The Museum Gardens are the place to let him stretch.",
    route: [[53.96566,-1.07431]],
    end: "York",
  },
  {
    id: "haworth",
...
// ------------------------------------------------------------
const PLACES = [
  { name: "M&S Simply Food", group: "need", at: [53.87123,-1.70927], note: "Park Road, Guiseley. About ten minutes in the car." },
