...
const WALKS = [
  {
    ...
    from: "Home",
    fromHome: "Out of the front door and go, this is the one that starts at home. Lane End is two minutes away and Bank Walk goes up from there.",
  ...
  },
  {
    ...
    fromHome: "Two ways. On foot from the door, do the village walk first and carry on up Northgate, which makes the whole thing about three hours. Or drive up Glen Road past Crook Farm to the moor car park, eight minutes, and the trig is twenty minutes up from there.",
  ...
  },
  {
    ...
    time: "About 2 hours",
    from: "Baildon village",
    fromHome: "Walk up to the village first (25 minutes, as above) and start the loop from there. Or drive down to Baildon station, five minutes, park free and do the loop the other way round, which saves you the climb home at the end.",
  ...
  },
  {
    ...
    fromHome: "Ten minutes on foot, down to Lane End and along Cliffe Lane to the little park. Not worth taking the car.",
  ...
  },
  {
    ...
    fromHome: "Six or seven minutes in the car, up Glen Road to the Old Glen House. On foot it's about half an hour from the door, or arrive on foot by doing the Cliffe Lane walk above first.",
  ...
  },
  {
    ...
    fromHome: "Ten minutes on foot to the west end of the bank, the same start as the Cliffe Lane walk. Don't take the car: you finish in Saltaire and come home on the train.",
  ...
  },
  {
    ...
    time: "20 min",
    from: "Ferniehurst",
    fromHome: "Ten minutes on foot, out past Ferniehurst. The one to do in a coat and no particular enthusiasm when it's dark and wet.",
